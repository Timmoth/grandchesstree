...
{
    public struct StatsLayerBuffers
    {
        public int BoardCount;

        public ArrayView1D<byte, Stride1D.Dense> Nodes;
        public ArrayView1D<byte, Stride1D.Dense> Captures;
        public ArrayView1D<byte, Stride1D.Dense> Enpassant;
        public ArrayView1D<byte, Stride1D.Dense> Castles;
        public ArrayView1D<byte, Stride1D.Dense> Promotions;
        public ArrayView1D<byte, Stride1D.Dense> DirectCheck;
        public ArrayView1D<byte, Stride1D.Dense> SingleDiscoveredCheck;
        public ArrayView1D<byte, Stride1D.Dense> DirectDiscoveredCheck;
        public ArrayView1D<byte, Stride1D.Dense> DoubleDiscoveredCheck;
        public ArrayView1D<byte, Stride1D.Dense> DirectCheckmate;
        public ArrayView1D<byte, Stride1D.Dense> SingleDiscoveredCheckmate;
        ...
        public StatsLayerBuffers(int boardCount,
            ...
            ArrayView1D<byte, Stride1D.Dense> castles,
            ArrayView1D<byte, Stride1D.Dense> promotions,
            ArrayView1D<byte, Stride1D.Dense> directCheck,
            ArrayView1D<byte, Stride1D.Dense> singleDiscoveredCheck,
            ArrayView1D<byte, Stride1D.Dense> directDiscoveredCheck,
            ArrayView1D<byte, Stride1D.Dense> doubleDiscoveredCheck,
            ArrayView1D<byte, Stride1D.Dense> directCheckmate,
            ArrayView1D<byte, Stride1D.Dense> singleDiscoveredCheckmate,
